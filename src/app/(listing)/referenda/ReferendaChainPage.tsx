...
// Preserved original chain Referenda listing page body.
...
async function ReferendaChainPage({ searchParams }: { searchParams: Promise<{ page?: string; status?: string }> }) {
...
export default ReferendaChainPage;

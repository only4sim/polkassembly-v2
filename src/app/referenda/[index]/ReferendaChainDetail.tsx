...
// Preserved original chain Referenda detail page body.
// This file is loaded only when ENABLE_BLOCKCHAIN=true.
...
async function ReferendaChainDetail({ params, searchParams }: { params: Promise<{ index: string }>; searchParams: Promise<{ created?: string }> }) {
	const { index } = await params;
	...
	// If created=true and no data, poll on the client side
...
export default ReferendaChainDetail;
